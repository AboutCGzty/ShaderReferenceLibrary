...
uniform uint uShadowCatcherIndirect;
...
void	AlbedoShadowCatcher( inout FragmentState s )
{
#ifdef MATERIAL_PASS_RT_PRIMARYHIT
	...
	//set indirect shadow flag
	s.shadowCatcherIndirect = uShadowCatcherIndirect != 0;
}

#define Albedo			AlbedoShadowCatcher
