...
void	TransmissionSubsurfaceScatterEvaluate( in FragmentState fs, inout SampleState ss )
{
	if( fs.frontFacing )
	{
...
void	TransmissionSubsurfaceScatterSample( in FragmentState fs, inout SampleState ss )
{
